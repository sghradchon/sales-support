...
import { Company,OrgMap,Organization, Contact,Opportunity, Activity} from "./TypesAndUtils"
import { OrgTreeNode,PositionedNode,DragOverMode,DragCandidate,DraggingState,SelectedEntity } from './TypesAndUtils';
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const newOrgMap: OrgMap = {};
        for (const org of orgs) {
          if (!newOrgMap[org.companyId]) {
            newOrgMap[org.companyId] = [];
          }
          newOrgMap[org.companyId].push(org);
        }
